/**
 * Seeds PaymentTermMaster, B2BCustomerType, B2BCustomerCategory, and the
 * B2B_CUSTOMER CommonStatusType/CommonStatus lifecycle for the primary dev tenant/company.
