...
function NewContractChildPolicy() {
  ...
  return (
    <div className="min-w-0 space-y-6 overflow-x-clip p-6">
      ...
      />
      <PropertyContractChildPolicyForm lockedContract={contract} />
    </div>
  );
}

export default function NewContractChildPolicyPage() {
  return (
          ...
          return (
            <div className="p-6">
              <EmptyState
                ...
                description="You don't have permission to manage contract child policies."
              />
            </div>
          );
        }
