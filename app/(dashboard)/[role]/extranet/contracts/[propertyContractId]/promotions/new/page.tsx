...
function NewContractPromotion() {
  ...
  return (
    <div className="min-w-0 space-y-6 overflow-x-clip p-6">
      <PageHeader
        ...
        actions={
          <Button
            ...
            nativeButton={false}
            render={
              <Link href={`/${role}/extranet/contracts/${contract.propertyContractKey}?tab=promotions`} />
            }
          >
      ...
      />
      <PropertyContractPromotionForm lockedContract={contract} />
    </div>
  );
}

export default function NewContractPromotionPage() {
  return (
          ...
          return (
            <div className="p-6">
              <EmptyState
                ...
                description="You don't have permission to manage contract promotions."
              />
            </div>
          );
        }
