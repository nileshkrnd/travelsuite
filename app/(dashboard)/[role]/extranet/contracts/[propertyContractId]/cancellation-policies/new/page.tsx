...
function NewContractCancellationPolicy() {
  ...
  return (
    <div className="min-w-0 space-y-6 overflow-x-clip p-6">
      ...
      />
      <PropertyContractCancellationPolicyForm lockedContract={contract} />
    </div>
  );
}

export default function NewContractCancellationPolicyPage() {
  return (
          ...
          return (
            <div className="p-6">
              <EmptyState
                ...
                description="You don't have permission to manage contract cancellation policies."
              />
            </div>
          );
        }
