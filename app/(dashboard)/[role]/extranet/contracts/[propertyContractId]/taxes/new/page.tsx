...
function NewContractTax() {
  ...
  return (
    <div className="min-w-0 space-y-6 overflow-x-clip p-6">
      ...
      />
      <PropertyContractTaxForm lockedContract={contract} />
    </div>
  );
}

export default function NewContractTaxPage() {
  return (
          ...
          return (
            <div className="p-6">
              <EmptyState
                ...
                description="You don't have permission to manage contract taxes."
              />
            </div>
          );
        }
