...
export default function NewContractInventoryPage() {
  return (
          ...
          return (
            <div className="p-6">
              <EmptyState
                ...
                description="You don't have permission to manage contract inventory."
              />
            </div>
          );
        }
