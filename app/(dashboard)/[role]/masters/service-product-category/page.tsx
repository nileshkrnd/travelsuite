...
import { Plus, LayoutGrid, Tags, MoreHorizontal, X, Search, Loader2, Star, ImageOff } from "lucide-react";
              ...
              <TableBody>
                {visible.map((row) => (
                  <TableRow key={row.serviceProductCategoryId}>
                    ...
                    <TableCell className="font-mono text-xs font-medium">{row.categoryCode}</TableCell>
                    ...
                    <TableCell className="text-muted-foreground">{row.parentCategoryName ?? "—"}</TableCell>
