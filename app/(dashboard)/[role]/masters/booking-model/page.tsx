...
import { Plus, BookMarked, MoreHorizontal, X, Search, Loader2 } from "lucide-react";
      ...
      <Card>
        {!loading && rows.length === 0 && scopeTenantId > 0 ? (
          ...
          <Table>
            <TableHeader>
              <TableRow>
                <SortableTableHead sortKey="bookingModelCode" activeKey={sortKey} direction={sortDirection} onSort={toggleSort}>
                  Code
                </SortableTableHead>
                <SortableTableHead sortKey="bookingModelName" activeKey={sortKey} direction={sortDirection} onSort={toggleSort}>
                  Name
                </SortableTableHead>
            ...
            <TableBody>
              {visible.map((row) => (
                <TableRow key={row.bookingModelId}>
                  <TableCell className="font-mono text-xs font-medium">{row.bookingModelCode}</TableCell>
                  <TableCell className="font-medium">{row.bookingModelName}</TableCell>
