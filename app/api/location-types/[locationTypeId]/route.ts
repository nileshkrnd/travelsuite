...
type RouteContext = { params: Promise<{ locationTypeId: string }> };

export async function PUT(request: Request, context: RouteContext) {
  try {
    const { locationTypeId } = await context.params;
    const id = idSchema.safeParse(locationTypeId);
