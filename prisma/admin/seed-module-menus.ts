...
export const ADMIN_MENU_PRODUCT_LINKS: Record<string, string[]> = {
  ...
  "administration/masters/general": ["Travel"],
  "administration/masters/property-product": ["Travel", "Real Estate"],
  "masters/additional-info-type": ["Travel"],
  ...
  "masters/contact-type": ["Travel"],
  "masters/address-type": ["Travel"],
  "masters/document-type": ["Travel"],
  "masters/b2b-customer-credit-status": ["Travel"],
  ...
  "masters/property-floor": ["Real Estate"],
  "masters/unit": ["Real Estate"],
  "property/unit-availability": ["Real Estate"],
  "masters/floor-type": ["Real Estate"],
  "masters/unit-type": ["Real Estate"],
  "masters/unit-category": ["Real Estate"],
  "masters/unit-status": ["Real Estate"],
  "masters/furnished-status": ["Real Estate"],
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              name: "General",
              url: "administration/masters/general",
              icon: "ListTree",
              children: [
                { name: "Contact Type", url: "masters/contact-type", icon: "Users" },
                { name: "Address Type", url: "masters/address-type", icon: "MapPin" },
                { name: "Document Type", url: "masters/document-type", icon: "FileBadge" },
              ],
            },
            {
              ...
              icon: "Package",
              children: [
                { name: "Additional Info Type", url: "masters/additional-info-type", icon: "FileText" },
              ],
            },
        ...
        },
        {
          ...
          children: [
            ...
            { name: "B2B Credit Status", url: "masters/b2b-customer-credit-status", icon: "CreditCard" },
          ],
        },
        {
          name: "Suppliers",
  ...
  Extranet: [
    {
      ...
      children: [
        ...
        {
          name: "Properties",
          url: "extranet/properties",
          icon: "Building2",
          children: [
            { name: "Select Property", url: "extranet/select-property", icon: "Building2" },
            { name: "Property Tenants", url: "masters/propertyTenant", icon: "UserSquare2" },
            ...
            { name: "Market Rules", url: "extranet/market-rules", icon: "Globe" },
            { name: "Contract Taxes", url: "extranet/taxes", icon: "Landmark" },
  ...
  "Property Management": [
    {
      ...
      icon: "Building2",
      children: [
        { name: "Unit Availability", url: "property/unit-availability", icon: "LayoutDashboard" },
        { name: "Properties", url: "masters/property", icon: "Home" },
        { name: "Floors", url: "masters/property-floor", icon: "Layers" },
        { name: "Units", url: "masters/unit", icon: "LayoutGrid" },
        { name: "Floor Type", url: "masters/floor-type", icon: "Layers" },
        { name: "Unit Type", url: "masters/unit-type", icon: "Building2" },
        { name: "Unit Category", url: "masters/unit-category", icon: "Tags" },
        { name: "Unit Status", url: "masters/unit-status", icon: "CircleDot" },
        { name: "Furnished Status", url: "masters/furnished-status", icon: "Sofa" },
      ],
    },
  ],
  "Tenant Management": [
