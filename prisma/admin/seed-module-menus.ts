...
export const ADMIN_MENU_PRODUCT_LINKS: Record<string, string[]> = {
  ...
  "masters/b2b-customer-contact-type": ["Travel"],
  "masters/address-type": ["Travel"],
  "masters/b2b-customer-document-type": ["Travel"],
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { name: "B2B Contact Type", url: "masters/b2b-customer-contact-type", icon: "Users" },
            { name: "Address Type", url: "masters/address-type", icon: "MapPin" },
            { name: "B2B Document Type", url: "masters/b2b-customer-document-type", icon: "FileBadge" },
